...
Welcome to the Autodesk Vault Data Standard Cookbook. This site distills the key automation hooks and scripting primitives from the official documentation into task-focused recipes for CAD administrators, solution consultants, and power users who extend Vault behavior.
...
Use the left-hand navigation or the quick links below:
